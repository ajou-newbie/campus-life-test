      ...
      <ResultImage>
          ...
          <ResultContainer>
              ...
              <MBTIResult>
                  ...
                  <Ulcontainer>
                      <ResultText>사람들의 감정을 잘 캐치하고 공감을 잘하는 당신은 원래 내향적이지만 사람들과 함께 있을 때만큼은 외향적으로 행동하는, 배려 가득한 사람이에요!</ResultText>
                      <ResultText>다른 사람의 부탁을 거절하는 일은 당신의 마음을 불편하게 만드는 세상에서 가장 어려운 일이에요. 그래서 그런지 주위 사람들로부터 착하고 친절한 사람이라는 이야기를 많이 들어왔어요.</ResultText>
                      ...
                      <ResultText>당신은 다른 사람의 일도 마치 나의 일인 것처럼 열심히 도와주지요. 물론 가끔씩 도와주기 싫을 때도 있지만..! 부탁을 거절하는 것이 미안해서라도 결국 웃으면서 도움을 제공하는 학교 대표 천사랍니다👼</ResultText>
                  </Ulcontainer>
              </MBTIResult>
              <SimiAndDiff>
                  <FlexContainer>
