          ...
          <ResultContainer>
              ...
              <MBTIResult>
                  ...
                  <Ulcontainer>
                      ...
                      <ResultText>친구들은 학우분께 공감능력이 결여된 것 같다고 말하지만, 사실은 그 누구보다 상대방의 기분을 빠르게 파악합니다.</ResultText>
                      <ResultText>다만, 남들이 듣고 싶어하는 말은 죽어도 해주기 싫은 것뿐이죠. - 또한, 과목마다 어떻게 공부하는 것이 가장 효율적인지 잘 알고 있습니다.</ResultText>
                      <ResultText>하지만 그래서, 미룰 수 있을 때까지 미루는 경향을 보입니다. “벼락치기”가 노력대비 최고의 효율을 낳는 공부법이기 때문이죠.</ResultText>
                  </Ulcontainer>
              </MBTIResult>
              <SimiAndDiff>
                  <FlexContainer>
