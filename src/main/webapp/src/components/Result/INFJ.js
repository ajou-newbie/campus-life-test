      ...
      <ResultImage>
          ...
          <ResultContainer>
              ...
              <MBTIResult>
                  ...
                  <ResultBlack>나 선배 아닌데..( ͡° ͜ʖ ͡°)</ResultBlack>
                  <ResultName>고학번 같은 새내기</ResultName>
                  <ResultImg>
                  </ResultImg>
                  <ResultText>- 생각이 너무 많아 세상의 모든 굴레와 속박에 찌든 고학번같은 면모를 보이는 당신.
                      <br></br><br></br>- 이미 상상만으로 당신은 학부 졸업까지의 모든 루트를 경험했습니다.
                      <br></br><br></br>- 의심이 많아 상대방이 호의를 그대로 받아들이지 못할 때가 많으며, 신세지는 것도, 피해주는 것도 싫어해서 밥약속, 술약속에서 보내줄 돈이 생기면 그 자리에서 바로 입금합니다.
                      <br></br><br></br>- 이러한 이유로 냉철하다는 평가를 받을 때도 있지만, 내면이 여리고 감수성이 풍부해 혼자만의 시간을 필요로 합니다.
                      <br></br><br></br>- 누군가 나에 대해 좋은 말을 하면 그에 대해 계속 생각하며 흐뭇해하고, 안 좋은 말을 하면 그에 대해 계속 생각하며 우울해합니다.
                  </ResultText>
              </MBTIResult>
              <SimiAndDiff>
                  <FlexContainer>
                  ...
                  <FlexContainer>
                      <SimiAndDiffName>미팅 하드 캐리</SimiAndDiffName>
                      <SimiAndDiffName>A+행 버스기사</SimiAndDiffName>
                  </FlexContainer>
              </SimiAndDiff>
              <Share>
