...
public class ChoiceRepositoryCustom {
	...
	public void init() {
		...
		choices5.add(new Choice("종강하는 그 날까지 이 수업 있는 날은 최대한 꾸미고 간다."));
		...
		choices6.add(new Choice("안녕하세요? 이름이 뭐예요? 폭풍 친화력을 발휘한다."));
		...
		choices7.add(new Choice("학생회관 3층 우측 복도 29번 사물함 안에 있어."));
		...
		choices8.add(new Choice("많이 바쁜가 보다 하고 그냥 넘어간다."));
		choices8.add(new Choice("쿨한 척 하고 싶지만 계속 신경 쓰여 답장을 기다린다."));
		choices8.add(new Choice("내가 잘못한 게 있나? 카톡을 모두 훑어본다."));
		...
		choices12.add(new Choice("평점 몇 점인데?"));
		choices12.add(new Choice("다음에 더 열심히 하면 되지 뭐~"));
